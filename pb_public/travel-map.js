...
class TravelMapModule {
     ...
     */
    applyThemeParkStyle() {
        // For amusement parks, use a more colorful and illustrated style
        // CartoDB Positron with enhanced styling works well
        ...
        // Set initial zoom to a comfortable level for park exploration
        if (map.getZoom() > 16) {
            map.setZoom(16);
        }
    }
    ...
    showAnimatedAttractionIcon(attraction) {
        ...
        // Pan map to attraction
        this.map.setView(attraction.latitude, attraction.longitude, 16);
    }
